...
let globalText = '전역변수';
function printLocal(globalText){
    let localText = '지역변수'
    console.log(localText)
}
console.log(globalText)  // localText는 { }밖으로 빠져나오지 X